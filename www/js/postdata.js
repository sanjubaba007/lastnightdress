...
$("#size1").on("click", function() {
    ...
    {
        $("#size1").css("background-color", "#000000");
    size1=0;
...
$("#size2").on("click", function() {
    ...
    {
        $("#size2").css("background-color", "#000000");
    size2=0;
     var itemtoRemove = 'XS';
...
$("#size3").on("click", function() {
    ...
    {
        $("#size3").css("background-color", "#000000");
    size3=0;
         var itemtoRemove = 'S';
...
$("#size4").on("click", function() {
    ...
    {
        $("#size4").css("background-color", "#000000");
    size4=0;
      var itemtoRemove = 'M';
...
$("#size5").on("click", function() {
    ...
    {
    $("#size5").css("background-color", "#000000");
    size5=0;
     var itemtoRemove = 'L';
...
$("#size6").on("click", function() {
    ...
    {
    $("#size6").css("background-color", "#000000");
    size6=0;
    var itemtoRemove = 'XL';
...
$("#size7").on("click", function() {
    ...
    {
        $("#size7").css("background-color", "#000000");
    size7=0;
  ...
  if(params.price=='')
  {
   ...
   return false;
      ...
      if(color.length==0)
    {
     ...
     params.condi =document.getElementById("status").value;
       if(params.condi==''&& selectcondition=='')
    {
